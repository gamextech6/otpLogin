...
const { sendOTP, sendForgetOTP, verifyOTP, registerUser, loginUser, resetPassword, updateUserProfile, getUserProfile, getUserBalance, getUserReferralCode, getAllUsers, blockUser, searchUserByUsername, unblockUser} = require("../controller/controller");
