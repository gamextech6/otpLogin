...
const { sendOTP, verifyOTP, addAgent, deleteAgent, deleteUser, adminDeductMoneyFromUser, adminAddMoneyToUser, addBankDetails, deleteBankDetail } = require("../controller/adminController");
